...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZFgithub.com/ti/common-go/docs/tutorial/restful/pkg/go/proto;pb'
  _globals['_REQUEST'].fields_by_name['name']._options = None
  _globals['_REQUEST'].fields_by_name['name']._serialized_options = b'\372B\004r\002( '
  _globals['_SAY'].methods_by_name['Hello']._options = None
  _globals['_SAY'].methods_by_name['Hello']._serialized_options = b'\202\323\344\223\002\022\022\020/v1/hello/{name}'
  _globals['_SAY'].methods_by_name['HelloStream']._options = None
  ...
  _globals['_SAY']._serialized_end=351
